...
$ ./bin/fmindex_pigeon_search --index myIndex.index --reference ../data/hg38_partial.fasta.gz --query ../data/illumina_reads_40.fasta.gz  # searches by using the fmindex
```
